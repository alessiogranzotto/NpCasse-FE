...
class _UserScreeenState extends State<UserScreeen> {
  ...
  void initializeControllers() {
    firstNameController = TextEditingController()..addListener(controllerListener);
    ...
    passwordController = TextEditingController()..addListener(passwordControllerListener);
    confirmPasswordController = TextEditingController()..addListener(passwordControllerListener);
  }
  ...
  void passwordControllerListener() {
    ...
    if (AppRegex.passwordRegex.hasMatch(password) && AppRegex.passwordRegex.hasMatch(confirmPassword) 
                              ...
                              Padding(
                                ...
                                child: CustomTextFormField(
                                  ...
                                  validator: (value) {
                                    return value!.isNotEmpty
                                        ? null
                                            : AppStrings.pleaseEnterTelephoneNumber;
                                  },
                                ),
                              ),
                              Row(
                                    ...
                                    child: ValueListenableBuilder(
                                      ...
                                      builder: (_, isValid, __) {
                                        return ElevatedButton(
                                          onPressed: isValid ? () { updateUserData(); } : null,
                                ...
                                builder: (_, passwordObscure, __) {
                                  return Padding(
                                    ...
                                    child: CustomTextFormField(
                                      ...
                                      suffixIcon: IconButton(
                                        onPressed: () => confirmPasswordNotifier.value = !passwordObscure,
                                        style: IconButton.styleFrom(
                                          minimumSize: const Size.square(48),
                                        ),
                                        icon: Icon(
                              ...
                              Row(
                                children: [
                                   Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: ValueListenableBuilder(
                                      valueListenable: passwordFieldValidNotifier,
                                      builder: (_, isValid, __) {
                                        return ElevatedButton(
                                          onPressed: isValid ? () { changePassword(); } : null,
                                          style: ElevatedButton.styleFrom(
                                            side: BorderSide(
                                              width: 1.0,
                                            ),
