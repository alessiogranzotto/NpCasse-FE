...
class _MassSendingHistoryScreenState extends State<MassSendingHistoryScreen> {
  ...
  void handleDownloadMassSendingHistoryList(BuildContext context) async {
    final reportMassSendingNotifier =
        Provider.of<ReportMassSendingNotifier>(context, listen: false);
    ...
    await reportMassSendingNotifier.downloadMassSendingHistoryList(
        context: context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Report invio massivo ${cUserAppInstitutionModel.idInstitutionNavigation.nameInstitution}',
            ...
            filterBarChild: PopupMenuButton(
              ...
              itemBuilder: (context) => <PopupMenuEntry>[
                ...
                PopupMenuItem(
                  ...
                  onTap: () {
                    handleDownloadMassSendingHistoryList(context);
                  },
                ),
              ],
            ),
