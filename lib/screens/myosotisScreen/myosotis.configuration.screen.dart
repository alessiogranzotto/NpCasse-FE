...
class MyosotisConfigurationScreen extends StatefulWidget {
  const MyosotisConfigurationScreen({super.key});

  @override
  State<MyosotisConfigurationScreen> createState() =>
      _MyosotisConfigurationScreenState();
}

class _MyosotisConfigurationScreenState
    extends State<MyosotisConfigurationScreen> {
  final double widgetWitdh = 250;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          'Configurazioni Myosotis ${cUserAppInstitutionModel.idInstitutionNavigation.nameInstitution}',
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              ...
              child: Consumer<MyosotisConfigurationNotifier>(
                builder: (context, myosotisConfigurationNotifier, _) {
                  return FutureBuilder(
                    future: myosotisConfigurationNotifier
                        .findMyosotisConfigurations(
                            context: context,
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        var tSnapshot =
                            snapshot.data as List<MyosotisConfigurationModel>;
                              ...
                              GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    MyosotisConfigurationModel
                                        ...
                                        tSnapshot[index];
                                    return MyosotisConfigurationCard(
                                        myosotisConfiguration:
                                            myosotisConfiguration);
                                  }),
                            ],
