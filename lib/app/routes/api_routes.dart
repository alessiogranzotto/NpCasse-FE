class ApiRoutes {
  ...
  static const String fiscalizationURL = "$casseURL/api/Fiscalization";
  ...
  static const String baseLogURL = "$casseURL/api/Log";
  static const String baseTaskURL = "$casseURL/api/Task";
