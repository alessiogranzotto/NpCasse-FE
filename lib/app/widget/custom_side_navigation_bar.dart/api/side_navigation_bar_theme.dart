...
class SideNavigationBarTheme {
  ...
  factory SideNavigationBarTheme.blue() => SideNavigationBarTheme(
        // Inherit from parent unless specifically set
        backgroundColor: CustomColors.darkBlue,
        itemTheme: SideNavigationBarItemTheme.blue(),
        togglerTheme: SideNavigationBarTogglerTheme.blue(),
        dividerTheme: SideNavigationBarDividerTheme.blue(),
      );
  factory SideNavigationBarTheme.light() => SideNavigationBarTheme(
        // Inherit from parent unless specifically set
        backgroundColor: Colors.white,
        itemTheme: SideNavigationBarItemTheme.light(),
        togglerTheme: SideNavigationBarTogglerTheme.light(),
        dividerTheme: SideNavigationBarDividerTheme.light(),
      );
  factory SideNavigationBarTheme.dark() => SideNavigationBarTheme(
        // Inherit from parent unless specifically set
        backgroundColor: Colors.black,
        itemTheme: SideNavigationBarItemTheme.dark(),
        togglerTheme: SideNavigationBarTogglerTheme.dark(),
        dividerTheme: SideNavigationBarDividerTheme.dark(),
      );
}
...
class SideNavigationBarItemTheme {
  ...
  factory SideNavigationBarItemTheme.light() => SideNavigationBarItemTheme(
        selectedItemColor: defaultSelectedItemColor,
        // Brightness dependant
        unselectedItemColor: null,
        iconSize: null,
  ...
  factory SideNavigationBarItemTheme.blue() => SideNavigationBarItemTheme(
  ...
  factory SideNavigationBarItemTheme.dark() => SideNavigationBarItemTheme(
        selectedItemColor: defaultSelectedItemColor,
        // Brightness dependant
        unselectedItemColor: null,
        iconSize: null,
...
class SideNavigationBarTogglerTheme {
  ...
  factory SideNavigationBarTogglerTheme.light() =>
      const SideNavigationBarTogglerTheme(
        // Brightness dependant
        expandIconColor: null,
        shrinkIconColor: null,
      );
  factory SideNavigationBarTogglerTheme.dark() =>
      const SideNavigationBarTogglerTheme(
        // Brightness dependant
        expandIconColor: null,
        shrinkIconColor: null,
      );
  factory SideNavigationBarTogglerTheme.blue() =>
      const SideNavigationBarTogglerTheme(
        // Brightness dependant
...
class SideNavigationBarDividerTheme {
  ...
  factory SideNavigationBarDividerTheme.light() =>
      const SideNavigationBarDividerTheme(
        showHeaderDivider: true,
        headerDividerColor: null,
        headerDividerThickness: null,
  ...
  factory SideNavigationBarDividerTheme.dark() =>
      const SideNavigationBarDividerTheme(
        showHeaderDivider: true,
        headerDividerColor: null,
        headerDividerThickness: null,
  ...
  factory SideNavigationBarDividerTheme.blue() =>
      const SideNavigationBarDividerTheme(
        showHeaderDivider: true,
        headerDividerColor: null,
        headerDividerThickness: null,
