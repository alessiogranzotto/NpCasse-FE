...
class ReportApi {
  ...
  Future findMyosotisDonationList(
    ...
    final Uri uri = Uri.parse(
        '${ApiRoutes.reportURL}/Find-myosotis-donation-list?idUserAppInstitution=$idUserAppInstitution&pageNumber=$pageNumber&pageSize=$pageSize&orderBy=$orderBy$filterJoined');
    final http.Response response = await client.get(
      uri,
      headers: {
        'Content-Type': 'application/json',
